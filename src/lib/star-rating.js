...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        language: 'en',
        stars: 5,
        filledStar: '<i class="iconfont icon-shoucang"></i>',
        emptyStar: '<i class="iconfont icon-shoucang"></i>',
        containerClass: '',
        size: 'md',
        animate: true,
        displayOnly: false,
        ...
        starCaptionClasses: {
            ...
            1.0: 'label label-danger',
            1.5: 'label label-warning',
            2.0: 'label label-warning',
            2.5: 'label label-info',
            3.0: 'label label-info',
            3.5: 'label label-primary',
            4.0: 'label label-primary',
            4.5: 'label label-success',
            5.0: 'label label-success'
        },
