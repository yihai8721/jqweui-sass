...
+ function($) {
    ...
    Photos.prototype = {
        ...
        adjust: function() {
            ...
            //è°ƒæ•´ä¸Šä¸‹
            if(rect.height < this.containerHeight) {  // å¦‚æžœé«˜åº¦æ²¡å®¹å™¨é«˜ï¼Œåˆ™è‡ªåŠ¨å±…ä¸­
                this.imageTransform.y = this.imageLastTransform.y = 0;
            } else {  //å¦‚æžœæ¯”å®¹å™¨é«˜ï¼Œé‚£ä¹ˆè¦ä¿è¯ä¸Šä¸‹ä¸èƒ½æœ‰ç©ºéš™
    ...
    defaults = Photos.prototype.defaults = {
        items: [],
        autoOpen: false, //åˆå§‹åŒ–å®Œæˆä¹‹åŽç«‹åˆ»æ‰“å¼€
        onOpen: undefined,
        onClose: undefined,
        initIndex: 0, //æ‰“å¼€æ—¶é»˜è®¤æ˜¾ç¤ºç¬¬å‡ å¼
        maxScale: 3,
